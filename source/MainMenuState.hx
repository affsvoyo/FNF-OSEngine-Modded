...
{
	public static var osEngineVersion:String = '0.0.9'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 44, 0, "Atlantic Engine v" + osEngineVersion + " + D&B Engine", 12);
